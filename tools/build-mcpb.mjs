...
const version = JSON.parse(readFileSync(path.join(root, 'manifest.json'), 'utf8')).version;   // single source of truth
writeFileSync(path.join(stage, 'package.json'), JSON.stringify({ name: 'numen', version, type: 'module', private: true }, null, 2) + '\n');
